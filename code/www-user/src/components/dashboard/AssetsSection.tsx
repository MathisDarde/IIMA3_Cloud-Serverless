  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-100">
      <div className="flex items-center justify-between mb-3">
        ...
        <label className={`text-xs bg-violet-600 hover:bg-violet-700 text-white font-medium px-3 py-1.5 rounded-lg transition-colors cursor-pointer ${uploading ? "opacity-50 pointer-events-none" : ""}`}>
            ...
            >
              ...
              <div className="flex gap-2 shrink-0 ml-3">
                <a
                  ...
                  className="text-xs text-violet-600 hover:text-violet-800 font-medium border border-violet-200 px-2 py-1 rounded-lg"
                >
                  Télécharger
                </a>
                <button
