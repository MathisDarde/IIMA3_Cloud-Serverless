    ...
    <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="text-sm bg-gray-900 hover:bg-gray-700 text-white font-medium px-3 py-1.5 rounded-lg transition-colors"
        >
          + Nouveau projet
        </button>
      </div>
      ...
      {showCreate && (
        <form onSubmit={handleCreate} className="mb-4 p-4 bg-gray-50 rounded-xl space-y-3">
          <h3 className="text-sm font-semibold text-gray-800">Nouveau projet</h3>
              ...
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-2 shrink-0 ml-4">
                  <button
                    ...
                    className="text-xs text-gray-900 hover:text-gray-800 font-medium border border-gray-200 px-3 py-1.5 rounded-lg"
                  >
                    Modifier
                  </button>
                  {canDelete && (
